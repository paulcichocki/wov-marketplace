...
interface HomeTopBuyersTableProps {
    buyerStats: BuyerStats;
    idx: number;
}

const HomeTopBuyersTable: React.FC<HomeTopBuyersTableProps> = ({
    buyerStats,
    idx,
}) => {
    const {
        ...
        <Box position="relative">
            <Link href={`/profile/${user?.customUrl ?? buyerAddress}`} passHref>
                ...
                >
                    ...
                    <Box display={{ _: "none", f: "block" }} width="27%">
                        <Text
                            textAlign="center"
                            variant="captionBold2"
                            pt={{ _: 3, f: "unset" }}
...
export default HomeTopBuyersTable;
