...
const AuctionHistoryItemAuctionCancelled: React.FC<AuctionHistoryItemProps> = ({
    item,
    auction,
}) =>
    item.user ? (
                ...
                <InfoWrapper>
                    <Text>
                        <Link href={item.checkTransactionLink} passHref>
                            <a target="_blank">Auction cancelled</a>
                        </Link>
                        &nbsp;by{" "}
                        <Link
...
export default AuctionHistoryItemAuctionCancelled;
